...
def moch_yayan():
    ...
    print(' [%s01%s]. Crack id from Group'%(O,N));time.sleep(0.03)
    print(' [%s02%s]. Crack id from public'%(O,N));time.sleep(0.03)
    print(' [%s03%s]. Crack id from followers'%(O,N));time.sleep(0.03)
    print(' [%s04%s]. Crack id from like'%(O,N));time.sleep(0.03)
    print(' [%s05%s]. Crack id from random'%(O,N));time.sleep(0.03)
    print(' [%s06%s]. Crack id from post'%(O,N));time.sleep(0.03)
    print(' [%s07%s]. Auto Checkpoint Detector'%(O,N));time.sleep(0.03)
    print(' [%s08%s]. User agent settings'%(O,N));time.sleep(0.03)
    print(' [%s09%s]. check crack result'%(O,N));time.sleep(0.03)
    print(' [%s10%s]. Upgrade to%s premium%s'%(O,N,H,N));time.sleep(0.03)
...
class __crack__:
    ...
    def plerr(self,id):
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            print(' [%s1%s]. method API (fast)'%(O,N))
            print(' [%s2%s]. method mbasic (slow)'%(O,N))
            print(' [%s3%s]. method mobile (Fast) [\033[92mRecommended\033[0m]'%(O,N))
            self.__pler__()
        else:
